    ...
    <div class="contentpanel">
        <div class="panel panel-primary-head">
            <div class="panel-heading row" style="margin-bottom: 10px;">
                <div class="col-xs-6">
                    <h4 class="panel-title">Tempat Uji Kompetensi</h4>
                    <p>Manajemen pengelolaan data TUK.</p>
                </div>
                        ...
                        <form id="tambahdata" class=" form-horizontal form-bordered">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    ...
                                    <div class="input-group">
                                        <textarea class="form-control" placeholder="ex: https://goo.gl/maps/bhx9e6KpUEdtDzzH9" name="tiklos" id="" cols="30"
                                            rows="6"></textarea>
                        ...
                        <form id="upddata" class="form-horizontal form-bordered">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    ...
                                    <label>Link Google Maps</label>
                                    <div class="input-group">
                                        <textarea class="form-control" placeholder="ex: https://goo.gl/maps/bhx9e6KpUEdtDzzH9" name="tiklos" id="tiklosu"
...
@push('staffjs')
    ...
    <script>
        ...
        function staffupd(id) {
            ...
            $("#idu").val(id.id);
            $("#namau").val(id.lokasi);
            $("#tiklosu").html(id.maps);
            if (id.gambar != null) {
                var html = `<img src="${url + '/gambar/tuk/' + id.gambar}"
